...
## Limitations
- Due to time constraints, the functionalities of '/ingest' and '/feedback' endpoint was not completed.
- As of now, there is no frontend interface available for the user to interact with the API.
